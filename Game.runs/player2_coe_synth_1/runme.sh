...
HD_PWD='C:/Progh/Game/Game.runs/player2_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log player2_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source player2_coe.tcl
