...
HD_PWD='C:/Progh/Game/Game.runs/speed_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log speed_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source speed_coe.tcl
