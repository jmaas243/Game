...
HD_PWD='C:/Progh/Game/Game.runs/freeze_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log freeze_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source freeze_coe.tcl
