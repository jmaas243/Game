...
HD_PWD='C:/Progh/Game/Game.runs/bomb_up_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bomb_up_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bomb_up_coe.tcl
