...
HD_PWD='C:/Progh/Game/Game.runs/wall_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wall_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wall_coe.tcl
