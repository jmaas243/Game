...
HD_PWD='C:/Progh/Game/Game.runs/player1_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log player1_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source player1_coe.tcl
