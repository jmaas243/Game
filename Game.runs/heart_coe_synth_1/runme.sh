...
HD_PWD='C:/Progh/Game/Game.runs/heart_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heart_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heart_coe.tcl
