...
HD_PWD='C:/Progh/Game/Game.runs/block_coe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_coe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_coe.tcl
